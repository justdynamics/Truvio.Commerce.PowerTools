...
using Keys = Truvio.Commerce.PowerTools.Features.Settings.Core.PowerToolsSettingKeys;
using Defaults = Truvio.Commerce.PowerTools.Features.Settings.Core.PowerToolsSettingKeys.Defaults;

namespace Truvio.Commerce.PowerTools.Features.Settings.Models;
