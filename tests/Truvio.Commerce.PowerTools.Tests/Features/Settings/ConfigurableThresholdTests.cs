...
namespace Truvio.Commerce.PowerTools.Tests.Features.Settings;
...
public class ConfigurableThresholdTests
{
    ...
    public void Table_share_threshold_decides_when_a_table_is_too_big_a_slice()
    {
        ...
        static bool Products(Finding f) =>
    ...
    public void The_engine_hands_the_configured_thresholds_to_its_rules()
    {
        ...
        Assert.Contains(findings, f => f.RuleId == LogGrowthRule.SizeId && f.Severity == FindingSeverity.Critical);
